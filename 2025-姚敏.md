...
#### 12.10
1. 成功训练完成
2. 在研究平面假设,如果对于低分辨率图片进行三角剖分，会导致不是一个平面的物体变成一个平面，如何适应patchmatchnet，从粗到细,是不是还是得全局共享平面参数<img width="2222" height="1015" alt="image" src="https://github.com/user-attachments/assets/5d95b6f4-c88a-4e68-b7a7-639985b699c7" />
