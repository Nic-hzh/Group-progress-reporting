...
3.<img width="1621" height="768" alt="image" src="https://github.com/user-attachments/assets/c2c90efc-555c-40b9-9e95-da63809fb884" />

### 1.22
#### 研究进度
1. 这一周就是在修改的patchmatch模块，平面假设生成和基于像素的特征扭曲代价计算
2. 解决了之前拟合平面函数，反向传播时梯度问题
3. 下一周继续修改patchmatch模块，加入三角传播和评估模块和选择模块
